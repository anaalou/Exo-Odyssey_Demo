...
{
    public string inputText = "Hello Martin, how are you?";
    ...
    public static RunJets instance;
     private void Awake(){
        if (instance == null)
        {
            instance = this;
    ...
    {
        return text
            .Replace("103", " 100 AND 3")
            .Replace("100", " 1 HUNDRED ")
            .Replace("200", " 2 HUNDRED ")
            .Replace("400", " 4 HUNDRED ")
            .Replace("500", " 5 HUNDRED ")
            .Replace("300", " 3 HUNDRED ")
            .Replace("90", " NINETY ")
            .Replace("0", " ZERO ")
            .Replace("1", " ONE ")
            .Replace("2", " TWO ")
            ...
            .Replace("9", " NINE ")
            .Replace("%", " PERCENT ")
            .Replace("exoplanets", " EXO PLANETS ")
            .Replace("exoplanet", " EXO PLANET ");
    }
